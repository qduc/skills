...
- **P6 Proportionality Skeptic:** abstractions with one implementation; dead flexibility (unused params, config, generics); dependency added for one trivial function; patterns (factories, event buses) with no second consumer.
