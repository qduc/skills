...
import { ConversationAdapter } from '../../services/conversation/conversation-adapter.js';
import type { SessionLogs, SessionApprovalQuery } from '../../services/session/session-composition.js';
...
it('emits an additive grantKind on the durable approval_resolved event (C11-D8 additive_grant_kind)', async () => {
